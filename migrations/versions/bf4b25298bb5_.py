...
Revision ID: bf4b25298bb5
Revises: 
Create Date: 2021-02-01 09:36:53.028179
...
def upgrade():
    ...
    sa.Column('change_request', sa.BOOLEAN(), nullable=True),
    sa.Column('change_request_only_admin_or_super_user', sa.BOOLEAN(), nullable=True),
    ...
    op.create_table('flicket_instruments',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('instrument', sa.String(length=30), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('flicket_request',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('request', sa.String(length=128), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('flicket_request_stages',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('request_stage', sa.String(length=30), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('request_stage_id', sa.Integer(), nullable=True),
    sa.Column('days', sa.Numeric(precision=10, scale=2), server_default='0', nullable=True),
    sa.ForeignKeyConstraint(['assigned_id'], ['flicket_users.id'], ),
    sa.ForeignKeyConstraint(['instrument_id'], ['flicket_instruments.id'], ),
    sa.ForeignKeyConstraint(['modified_id'], ['flicket_users.id'], ),
    sa.ForeignKeyConstraint(['request_id'], ['flicket_request.id'], ),
    sa.ForeignKeyConstraint(['request_stage_id'], ['flicket_request_stages.id'], ),
...
def downgrade():
    ...
    op.drop_table('flicket_request_stages')
    op.drop_table('flicket_request')
    op.drop_table('flicket_instruments')
